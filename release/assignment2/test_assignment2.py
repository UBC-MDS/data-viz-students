...
def test_1_2(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    sha1((answer.lower() + "w").encode('utf8')).hexdigest() == "8e425ff79c7c294266f1a4093c553d06af472609", "Your answer is incorrect. Please try again."
    return("Success")

def test_1_3(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    sha1((answer.lower() + "k").encode('utf8')).hexdigest() == "b86f6db284d374188d561d46b45b188d5631609a", "Your answer is incorrect. Please try again. Are you examining the plots correctly?"
    return("Success")

def test_1_5(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    sha1((answer.lower() + "x").encode('utf8')).hexdigest() == "6eeb3fecf98e6cb569171a38808fac301b190eab", "Your answer is incorrect. Please try again."
    return("Success")

def test_1_6(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    sha1((answer.lower() + "z").encode('utf8')).hexdigest() == "90283840d90de49b8e7984bd99b47fee0d4bd50d", "Your answer is incorrect. Please try again."
    return("Success")

def test_1_7(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    sha1((answer.lower() + "a").encode('utf8')).hexdigest() == "cdd4f874095045f4ae6670038cbbd05fac9d4802", "Your answer is incorrect. Please try again."
    return("Success")
...
def test_2_2_2(answer):
    ...
    assert not answer.encoding.y.title is None, "Make sure you are providing a title for your X-axis"
...
def test_2_4(answer):
    ...
    assert sha1(str(sorted([x.lower() for x in answer])).encode('utf8')).hexdigest() == "00dd0637ea7a465c83c8998839813d71f0f956a3", "Your answer is incorrect. Please try again. Are you examing the plots correctly?"
    return("Success")

def test_3_1(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    sha1(str(answer).encode('utf8')).hexdigest() == "39e21432a7dcba489697b4ef779f4b0c6f08b89f", "Your answer is incorrect. The 'max' and 'isna() functions might be useful here."
    return("Success")
...
def test_3_5(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    sha1((answer.lower()).encode('utf8')).hexdigest() == "133f5f567509940df6c46c9597e28f976a75fa71", "Your answer is incorrect. Please try again. Are you examining the plots correctly?"
    return("Success")

def test_3_6(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    sha1(str(answer).encode('utf8')).hexdigest() == "da4b9237bacccdf19c0760cab7aec4a8359010b0", "Your answer is incorrect. Please try again. Are you examining the plots correctly?"
    return("Success")


def test_3_8(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    assert answer.shape == (38982, 15), "Your dataframe dimensions are incorrect. Are you adding the the new column?"
...
def test_3_11(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    sha1((answer.lower()).encode('utf8')).hexdigest() == "3ab9380fa2521f2d0d94fe931b79a1e1eaa91890", "Your answer is incorrect. Please try again. Are you examining the plot correctly?"
    return("Success")

def test_3_12(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    sha1(str(int(answer)).encode('utf8')).hexdigest() == "91032ad7bbcb6cf72875e8e8207dcfba80173f7c", "Your answer is incorrect. Please try again."
    return("Success")

def test_3_13_1(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    assert answer.mark == 'area', "Make sure you are creating a area plot using the 'mark.area()' function."
...
def test_3_14(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    sha1((answer.lower() + 'p').encode('utf8')).hexdigest() == "3f81e91d69a8a61ffbf19297eb0791ad54ce5690", "Your answer is incorrect. Please try again. Are you examining the plot correctly?"
    return("Success")

def test_3_15(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    sha1((answer.lower()).encode('utf8')).hexdigest() == "79be276817ebcd106b9fc3d227e18059faf7790e", "Your answer is incorrect. Please try again. Are you examining the plot correctly?"
    return("Success")
...
def test_4_5(answer):
    assert not answer is None, "Your answer does not exist. Have you passed in the correct variable?"
    assert sha1((answer.lower()).encode('utf8')).hexdigest() == "fb360f9c09ac8c5edb2f18be5de4e80ea4c430d0", "Your answer is incorrect. Please try again. Are you examing the plots correctly?"
    return("Success")
