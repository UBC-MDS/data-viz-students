...
def test_2_1a(answer):
    ...
    assert answer.mark.color != alt.utils.schemapi.Undefined, "Make sure you are giving your bar plot a nice colour other than the default colour."
...
def test_3_3a(answer1, answer2):
    ...
    assert (type(answer2.encoding.tooltip) == list and
            len(answer2.encoding.tooltip) == 1), "Your tooltip should have 1 channel ('birth_state')."
    assert (
...
def test_4_3b(answer1, answer2, answer3):
    ...
    assert type(answer2) == alt.Chart, "Your answer for filtered_bats_bars should be an altair Chart."
    assert type(answer3) == alt.VConcatChart, "Your answer for map_bat_plot should be an altair VConcatChart."
